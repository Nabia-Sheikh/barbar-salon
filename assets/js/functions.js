...
(function ($) {
  ...
  /* ------------------  AJAX MAILCHIMP ------------------ */
  $(".mailchimp").ajaxChimp({
    url: "https://wplly.us5.list-manage.com/subscribe/post?u=91b69df995c1c90e1de2f6497&id=aa0f2ab5fa", //Replace with your own mailchimp Campaigns URL.
  ...
  var instafeedSidebar = $("#instafeedSidebar").length,
    ...
    /*YOUR_USER_ID*/
    InstaAccessToken =
      "6541563850.1677ed0.dd29bed64bee43e1be15068bf2b92687"; /*YOUR_ACCESS_TOKEN*/
  ...
  if (instafeedSidebar > 0) {
    var userFeedSidebar = new Instafeed({
      ...
      template:
        '<a href="{{link}}" target="_blank"><img src="{{image}}" /><div class="insta-hover"><i class="fa fa-plus"></i></div></a>',
